...
REM
REM Generated by Vivado on Sun Mar 01 18:48:36 +0100 2026
...
echo "xvhdl --incr --relax -prj stackSim_vhdl.prj"
call xvhdl  --incr --relax -prj stackSim_vhdl.prj -log xvhdl.log
