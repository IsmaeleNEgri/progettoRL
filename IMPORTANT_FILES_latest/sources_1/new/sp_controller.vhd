...
begin
    ...
    sp_out <= (others => '0') when clear = '1' or rst='1' 
        else sp when (do_push='1' and Cout='1') or (do_pop='1' and sp="000") or (do_pop='1' and isFullBuffer ='1') --blocca l'overflow 111→000 e blocca l'underflow 000→111
        else spNext when (do_pop='1' or do_push='1') 
        else sp;
